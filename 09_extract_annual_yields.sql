...
ccrop as crop11,
(CASE WHEN ccrop = 'CG' THEN (yield / 39.368 ) * 2.471 ELSE (yield / 36.7437) * 2.471 END) as yield11
...
ccrop as crop12,
(CASE WHEN ccrop = 'CG' THEN (yield / 39.368 ) * 2.471 ELSE (yield / 36.7437) * 2.471 END) as yield12
FROM clumu_cgsb_profit_2011_2014 
WHERE year = '2012'
),
yieldtable13 AS (
...
ccrop as crop13,
(CASE WHEN ccrop = 'CG' THEN (yield / 39.368 ) * 2.471 ELSE (yield / 36.7437) * 2.471 END) as yield13
FROM clumu_cgsb_profit_2011_2014 
WHERE year = '2013'
),
yieldtable14 AS (
...
ccrop as crop14,
(CASE WHEN ccrop = 'CG' THEN (yield / 39.368 ) * 2.471 ELSE (yield / 36.7437) * 2.471 END) as yield14
FROM clumu_cgsb_profit_2011_2014 
WHERE year = '2014'
),
yieldtable1112 AS (
